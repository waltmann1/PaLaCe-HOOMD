...
class THR(ResidueAbs):
    ...
    def __init__(self, data=None, error_470=False):
        ...
        self.bio_atoms = 7
        self.beads = 7
        super(THR, self).__init__(data, error_470=error_470)
        self.name = 'Threonine'
        self.letter = 't'
        self.code = 'THR'
        self.bio_atoms = 7
