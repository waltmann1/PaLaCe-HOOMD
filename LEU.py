...
class LEU(ResidueAbs):
    ...
    def __init__(self, data=None, error_470=False):
        ...
        self.bio_atoms = 8
        self.beads = 7
        super(LEU, self).__init__(data, error_470=error_470)
        self.name = 'Leucine'
        self.letter = 'l'
        self.code = 'LEU'
        self.bio_atoms = 8
